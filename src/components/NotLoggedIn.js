    ...
    return(
        <div>
            ...
            <div style={{marginBottom: 30}}>
                <div onClick={show_login_page} style={{margin: "auto", textAlign: "center", maxWidth: 450, padding: "14px 10px", backgroundColor: "rgb(54, 117, 168)", borderRadius: 9, color: "white"}}>
