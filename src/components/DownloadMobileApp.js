            ...
            <div className="download_mobile_section">
                <div className="download_mobile_app_section_container">
                    ...
                    <div className="download_mobile_app_btn_container">
                        <div style={{cursor: "pointer", fontSize: 14, textAlign: "center", color: "white", backgroundColor: "rgb(54, 117, 168)", padding: 10, borderRadius: 20, minWidth: 120}}>
                            <i className="fa fa-download" style={{marginRight: 5, color: "rgba(255,255,255,0.4)"}}></i>download
                        </div>
                    </div>
                </div>
            </div>
