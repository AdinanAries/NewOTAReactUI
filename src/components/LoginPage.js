                ...
                <div style={{padding: "30px 5px"}}>
                    ...
                    <div style={{maxWidth: "600px", margin: "auto", marginTop: 30, border: "1px solid rgba(0,0,0,0.2)", borderRadius: 9, overflow: "hidden"}}>
                        ...
                        <div style={{padding: "10px",}}>
                            ...
                            <div style={{color: "white", backgroundColor: "rgb(24, 67, 98)", textAlign: "center", padding: 14, borderRadius: 9}}>
                                Login
                            </div>
                            <p style={{marginTop: 15, color: "darkcyan", cursor: "pointer", fontSize: 14}}>Forgot your password?</p>
                            <p style={{marginTop: 20, backgroundColor: "rgb(43, 52, 61)", width: "fit-content", color: "white", textAlign: "center", padding: "14px", width: "200px", borderRadius: 5, cursor: "pointer"}}>
